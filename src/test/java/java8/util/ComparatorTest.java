...
public class ComparatorTest {
	...
	public void testComparator() {
		...
		Comparator<Student> studentComparator= Comparator.comparator(Student::getAge).thenComparingWith(Student::getFirstName).thenComparingWith(Student::getLastName);;
